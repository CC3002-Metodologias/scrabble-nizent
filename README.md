...
Finally, you can remove an element, by dragging and dropping over the red semi-circle
![start1](https://github.com/nizent/images/blob/main/img12.png?raw=true)
If the node is drop over the semi-circle, it will disappear
![start1](https://github.com/nizent/images/blob/main/img13.png?raw=true)
# Model
# Types
