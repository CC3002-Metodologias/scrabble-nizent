...
public abstract class AbstractNumber extends AbstractScrabbleType implements INumber {
     ...
     */
    public abstract INumber sumToInt(ScrabbleInt scrabbleInt);
     ...
     */
    public abstract INumber subtractToInt(ScrabbleInt scrabbleInt);
     ...
     */
    public abstract INumber divideToInt(ScrabbleInt scrabbleInt);
     ...
     */
    public abstract INumber multiplyToInt(ScrabbleInt scrabbleInt);
     ...
     */
    public abstract INumber sumToFloat(ScrabbleFloat scrabbleFloat);
     ...
     */
    public abstract INumber subtractToFloat(ScrabbleFloat scrabbleFloat);
     ...
     */
    public abstract INumber divideToFloat(ScrabbleFloat scrabbleFloat);
     ...
     */
    public abstract INumber multiplyToFloat(ScrabbleFloat scrabbleFloat);
}
