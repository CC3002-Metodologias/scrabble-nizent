...
public interface IInteger extends INumber {
     ...
     */
    ScrabbleBinary sumToBinary(ScrabbleBinary scrabbleBinary);
     ...
     */
    ScrabbleBinary subtractToBinary(ScrabbleBinary scrabbleBinary);
     ...
     * @return a new IInteger containing the result
     */
    ScrabbleBinary divideToBinary(ScrabbleBinary scrabbleBinary);
     ...
     * @return a new IInteger containing the result
     */
    ScrabbleBinary multiplyToBinary(ScrabbleBinary scrabbleBinary);
}